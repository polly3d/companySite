...
(function() {
	...
	$('#comment_main').html('<if'+'rame src="'+EXPath+'comment.php?mid='+module_id+'&itemid='+item_id+'" name="destoon_comment" id="des'+'toon_comment" style="width:99%;height:0px;" scrolling="no" frameborder="0"></if'+'rame>');
})();
